...
const EditPost = () => {
    ...
    /*The useParams hook returns an object containing the key-value pairs of the URL parameters.
I    n this case, useParams().id accesses the id parameter from the URL. */
    /*<Route exact path="/edit/:id" element={<EditPost/>}/> from this it extract the id part */
